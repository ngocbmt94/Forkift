...
class RecipeView {
  ...
  render(data) {
    this.#data = data;
    const htmlGenerateRecipe = this.#generateRecipe();
    this.#parentEl.innerHTML = '';
    this.#parentEl.insertAdjacentHTML('afterbegin', htmlGenerateRecipe);
  }
  ...
  #generateRecipe() {
    ...
    <div class="recipe__ingredients">
      ...
      ${this.#renderIngredients(this.#data.ingredients)}
      </ul>
    </div>
  ...
  renderSpinner() {
    ...
    `;
    this.#parentEl.innerHTML = '';
    this.#parentEl.insertAdjacentHTML('afterbegin', htmlSpinner);
  }
